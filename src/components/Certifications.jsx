...
const certifications = [
  ...
  },
  {
  ...
  },
   {
    ...
    degree: '30-Day Masterclass in Power BI',
    period: 'Aug 2025',
    credentialId: 'NT_B1PBIT605',
    desc: 'Completed an intensive 30-day Power BI masterclass covering data transformation with Power Query, data modeling, DAX, interactive dashboards, data visualization, report publishing, and business intelligence concepts.',
    skills: ['Power Query','DAX','Data Modeling','Data Visualization','Dashboard Development','Report Design','Data Transformation','ETL','Excel'],
     icon: '📜',
  },
  {
    institution: 'NoviTech R&D Pvt Ltd',
